namespace OutXApp.Migrations
{
    ...
    public partial class InitialDb : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Courses", "CityId", "dbo.Cities");
            DropForeignKey("dbo.Attendances", "CourseId", "dbo.Courses");
            DropForeignKey("dbo.Appointments", "CourseId", "dbo.Courses");
            ...
            DropIndex("dbo.Courses", new[] { "CityId" });
            ...
            DropIndex("dbo.Appointments", new[] { "CourseId" });
